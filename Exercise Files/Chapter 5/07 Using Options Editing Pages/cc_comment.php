...
{
	add_menu_page('CC Comments', 'CC Comments', 'manage_options', 'cc_comments-plugin', 'cccomm_option_page', '/wordpressTesting/wp-content/plugins/cc_comment/cc_icon.png',30);
	add_submenu_page('cc_comments-plugin','CC Comments Options 2', 'CC Comments Options 2', 'manage_options', 'cc_comments-plugin2', 'cccomm_option_page');
}
